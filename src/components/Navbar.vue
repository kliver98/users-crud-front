      ...
      <b-navbar toggleable="lg" type="dark" variant="info">
        ...
        <b-collapse id="nav-collapse" is-nav>
          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-form>
              <b-button class="btn btn-success float-right" type="submit" v-on:click="loginShow()"><span id="btnLogin">Iniciar sesion</span></b-button>
            </b-nav-form>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      axios
        .post(this.baseAPIauth, userInfo)
        .then((res) => {
          console.log(res.data.username);
          this.loginShow();   
          document.getElementById("btnLogin").innerHTML = "Bienvenido " + res.data.username         
        })
        .catch(() => {
